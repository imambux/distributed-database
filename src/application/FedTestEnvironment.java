...
public class FedTestEnvironment {
    ...
    public void run(String filename, boolean debug) {
        ...
        while (scanner.hasNext()) {
            ...
            if (!"".equals(statement)) {
                if (!"SET ECHO ON".equals(statement.toUpperCase())
                        && !statement.toUpperCase().startsWith("ALTER SESSION")) {
                    if (debug) {
                        ...
                        if (statement.toUpperCase().equals("ROLLBACK")) {
                            ...
                            if (statement.toUpperCase().startsWith("SELECT")) {
                                ...
                                try {
                                    ...
                                    FedResultSet fedResultSet = fedStatement
        ...
        delta = end - start;
        System.out.println("File '" + filename + "', " + op + " operations, "
                + delta + " milliseconds");
        System.out.println(
                "**************************************************************************\n");
        // fix: Resource leak: '<unassigned Closeable value>' is never closed
        scanner.close();
